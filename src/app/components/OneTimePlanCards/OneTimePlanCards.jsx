  ...
  return (
    <section className="flex flex-col md:flex-row justify-center items-center md:items-between gap-10 md:gap-20">
      <div className={`${styles.cardBg} w-fit h-fit p-2 rounded-[2rem]`}>
        <div className="bg-white rounded-[2rem] min-w-[340px] w-[34rem] md:w-[40rem] md:min-w-fit min-h-fit h-[40rem] flex flex-col items-center justify-evenly text-center px-10 md:px-20 py-10">
